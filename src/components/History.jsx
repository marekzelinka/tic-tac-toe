      ...
      {history.map((_squares, move) => (
        <li key={move}>
          {move === 0 && currentMove === 0 ? (
            <p className="px-6 py-3 text-sm/6 text-gray-500 dark:text-gray-400">
            ...
            <button
              type="button"
              onClick={() => onJump(move)}
              className="flex w-full items-center px-6 py-3 text-sm/6 font-semibold text-gray-900 hover:bg-gray-50 dark:text-white dark:hover:bg-white/10"
            >
